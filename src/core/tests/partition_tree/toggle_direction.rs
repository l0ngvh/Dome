...
fn toggle_direction_inside_tabbed_only_affects_tabbed_subtree() {
    ...
    Hub(focused=WindowId(7))
      Monitor(id=MonitorId(0), screen=(x=0.00 y=0.00 w=150.00 h=30.00),
        Window(id=WindowId(7), x=138.00, y=2.00, w=12.00, h=28.00, highlighted, spawn=right)
        Window(id=WindowId(6), x=125.00, y=2.00, w=13.00, h=28.00)
        Window(id=WindowId(5), x=113.00, y=2.00, w=12.00, h=28.00)
        Window(id=WindowId(4), x=100.00, y=2.00, w=13.00, h=28.00)
...
fn toggle_direction_noop() {
    ...
    let mut hub = setup_with_tiling(tiling_floating(&["w8"]));
    hub.insert_window(
        titled("w8"),
